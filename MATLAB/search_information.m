...
% This function is a modified version of the eponymous function in the BCT.
% Weight-to-length transformations are to be handled externally by the user,
% who must provide both connection weight and length matrices. All other
% computations are carried out as in the BCT function.
%
% Caio Seguin Jan 2019
